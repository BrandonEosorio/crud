<div class="row padding-1 p-1">
    <div class="col-md-12">
        ...
        <div class="form-group mb-2 mb20">
            ...
            <input type="text" name="Producto" class="form-control @error('Producto') is-invalid @enderror" value="{{ old('Producto', $product?->Producto) }}" id="producto" placeholder="Producto">
